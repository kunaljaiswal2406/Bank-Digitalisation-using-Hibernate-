...
import forms.ManagerLogin;
import org.hibernate.Criteria;
import org.hibernate.Session;
import org.hibernate.SessionFactory;
import org.hibernate.cfg.Configuration;
import bankhibernate.ManagerLoginh;
...
public class ManagerLogin extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ManagerLoginhbm
     */
    public ManagerLogin() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String password = (String) new String(pas);
        SessionFactory sf = new Configuration().configure().buildSessionFactory();
        Session session = sf.openSession();
        Criteria crit = session.createCriteria(bankhibernate.ManagerLoginh.class);
        crit.add(Restrictions.and(Restrictions.eq("id", jTextField1.getText()), Restrictions.eq("password", password)));
        List<ManagerLogin> li = crit.list();
        if (li.isEmpty()) {
